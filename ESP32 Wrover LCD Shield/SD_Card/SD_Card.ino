...
void setup()
{
    ...
    removeDir(SD, "/mydir");
    listDir(SD, "/", 2);
    writeFile(SD, "/lonelybinary.txt", "Lonely ");
    appendFile(SD, "/lonelybinary.txt", "Binary!\n");
    readFile(SD, "/lonelybinary.txt");
    deleteFile(SD, "/foo.txt");
    renameFile(SD, "/lonelybinary.txt", "/foo.txt");
    readFile(SD, "/foo.txt");
